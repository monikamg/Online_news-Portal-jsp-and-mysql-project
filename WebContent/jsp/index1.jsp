...
if(document.subscribe_form.susbscriber_email.value == "")
{
alert('Please input Email');
document.subscribe_form.susbscriber_email.focus();
return false;
} 
}
</script>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
    ...
    <link rel="stylesheet" type="text/css" href="layout/styles/navi.css"/>
     <script rel="stylesheet" type="text/javascript" src="layout/scripts/galleryviewthemes/jquery.easing.1.3.js"/>
     
     <script rel="stylesheet" type="text/javascript" src="layout/scripts/galleryviewthemes/jquery.galleryview.2.1.1.min.js"></script>
     <script rel="stylesheet" type="text/javascript" src="layout/scripts/galleryviewthemes/jquery.galleryview.setup.js"></script>
     <script rel="stylesheet" type="text/javascript" src="layout/scripts/galleryviewthemes/jquery.timers.1.2.js"></script>
...
<div class="wrapper col0">
  <div id="topline">
    ...
    <ul>
      <li><a href="#">Home</a></li>
      <li><a href="pages/area_of_interest.jsp">Area of preference</a></li>
      <li><a href="#">Contact Us</a></li>
      <li class="last"><a href="pages/admin_login.jsp">Admin Login</a></li>
    </ul>
    <br class="clear" />
  </div>
</div>
...
<div class="wrapper">
  <div id="header">
    <div class="fl_left">
      <h1><a href="index.jsp"><strong>O</strong>nline <strong>N</strong>ews <strong>P</strong>ortal</a></h1>
      <p>All About News - Online News Portal</p>
    </div>
    <div class="fl_right"><a href="#"><img src="layout/images/demo/news.jpg" alt="" /></a></div>
    <br class="clear" />
  </div>
</div>
  ...
  <div id="topbar">
    <div id="topnav">
      <ul>
        ...
        <li><a href="pages/sports.jsp">Sports</a></li>
        <li><a href="pages/entertainment.jsp">Entertainment</a></li>
        <li><a href="pages/Technology.jsp">Technology</a></li>
        <li><a href="pages/world.jsp">World</a></li>
        <li><a href="pages/latest_news_tech.jsp">Latest News</a></li>
  ...
  <div class="container">
    <div class="content">
      <div id="featured_slide">
        <ul id="featurednews">
          <li><img src="layout/images/demo/download.jpg" alt="1" />
...
<div class="wrapper">
  <div id="socialise">
    ...
    <div id="newsletter">
      ...
      <p>Please enter your Email and Name to Subscribe.</p>
      <form name="subscribe_form" action="sendingemail.jsp" method="post" onSubmit=" return check()">
        <fieldset>
          <legend>Digital Newsletter</legend>
          <div class="fl_left">
            <input type="text" value="Enter name here&hellip;"  onfocus="this.value=(this.value=='Enter name here&hellip;')? '' : this.value ;" data-validate = "Valid email is: a@b.c"/>
            <input type="text" value="Enter email address&hellip;"   name="susbscriber_email" />
