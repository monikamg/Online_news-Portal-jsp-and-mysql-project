...
<%
    ...
    Connection con = DriverManager.getConnection("jdbc:mysql://localhost/admin", "root", "mysql");
    ...
    int j = st.executeUpdate("insert into log(adminfname) values ('"+fname+"')");
    if (i > 0) {
       ...
       // procstate.execute();
       // procstate.close();
       //pro=con.prepareCall("{call cursor1}");
      // procstate=con.prepareCall("{call test()}");
